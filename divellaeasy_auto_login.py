#!/usr/bin/env python3
# divellaeasy_auto_login.py
# Versione con 88 nuove chiavi Browserless
...
# ================ NUOVE CHIAVI BROWSERLESS (88 chiavi) ====================
BROWSERLESS_KEYS = [
    "2UI9I1FMeNAJT9X62b18b40ff03c0ab5a398738215c1a35bd",
    "2UI9JVRncuIpZrwe20186f338163de3534ad76e9e184c3f09",
    "2UI9xpzoJEYcY6nb2f6c397ca82c2d20dd03b736569bb072d",
    "2UI9yKT57zjUKeC17f2ef139dfb21e9391f2d96790e302f9b",
    "2UIA0m3dx66LBXE6a4b1186de64e0bd63678935960ad9372e",
    "2UIA2sljufDcaR475a778652b378cf6f77ac9fa9d4c5a32ef",
    "2UIA3tICKePo9wi2cbbf16afdab74a0660c1f7d582bf307fa",
    "2UIA56wVRPRiIJZf4be8d0d1ab54be1eb959f69334b81b6df",
    "2UIA72xUceBrbAC4beef9639833ec0d7edad133f85dfe1587",
    "2UIA8QdgmdsAc6v54560d55760e5919aab9f182f0f205b8d6",
    "2UIAAcCwwgjo8Jxda1d47ae047d722baa66197cef02c73df2",
    "2UIABDOnt0tb9cR4c4922c4e006e57e6c3570a7e08e605e9b",
    "2UFyHOdxsID23VMa0518a22c6b683ea3c11c1bdca148d5381",
    "2UIAHVuiTuotW5oa9a17ea35ffa0b176467ae249cb2e9c21d",
    "2UIAJ7EX7Cx0Isgc2a222a17b162723bec7c26999971cd4a8",
    "2UIAKZEPm9504lA7c89aff2d1a98319c74044d24fcfed1b8f",
    "2UIAM3ZqWKMs08wcd3acdc7cc7e95f61c1c6d58b70d30cdb2",
    "2UIANrMUJlMFYt97b604e6e370cf6ac938a182cc12888f03a",
    "2UIAPhsYM2P5F20b3a57ce055cadb610e4b1e488e498a23c3",
...
def do_login():
    """Esegue login via Browserless e restituisce cookie"""
...
def main():
    ...
    # Ciclo principale con refresh automatico
    while True:
        # Login per ottenere cookie freschi
        cookies = do_login()
        if not cookies:
        ...
        while True:
            try:
                ...
                if r.status_code != 200:
                    log(f"❌ Status {r.status_code} - Cookie scaduti? Esco dal loop surf")
                    break
                ...
                if not urlid or not qpic or not picmap or len(picmap) < 5:
                    log(f"❌ Dati incompleti - Cookie scaduti? Esco dal loop surf")
                    break
